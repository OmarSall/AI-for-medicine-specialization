...
def check_for_leakage(df1, df2, patient_col):
    ...
    df1_patients_unique = set(df1)
    df2_patients_unique = set(df2)
...
def get_weighted_loss(pos_weights, neg_weights, epsilon=1):
    """
    ...
    def weighted_loss(y_true, y_pred):
        ...
        for i in range(len(pos_weights)):
            ...
            loss += - (pos_weights * y_true * np.log(y_pred) + neg_weights*(1-y_true) * np.log(1 - y_pred)) #complete this line
        return loss
